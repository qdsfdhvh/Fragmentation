...
import me.yokeyword.sample.zhihu.adapter.FirstHomeAdapter
...
class FirstHomeFragment : SupportFragment(), SwipeRefreshLayout.OnRefreshListener {
    ...
    private val mImgRes = intArrayOf(
        R.drawable.bg_first,
    ...
    private fun initView(view: View) {
        ...
        mFab!!.setOnClickListener { Toast.makeText(ctx, "Action", Toast.LENGTH_SHORT).show() }
    }
